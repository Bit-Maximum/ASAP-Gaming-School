...
public class GroundPatrolEnemy : MonoBehaviour
{
    ...
    public float AttackPrepareTime { get; private set; }
    ...
    [SerializeField] private Vector2 _cliffCheckSize = new Vector2(0.5f, 1f);
    ...
    private void Update()
    {
        ...
        AttackPrepareTime -= Time.deltaTime;
        #endregion
    }
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireCube(_cliffCheckPoint.position, _cliffCheckSize);
    }
    #endregion
}